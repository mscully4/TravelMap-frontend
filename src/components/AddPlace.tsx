...
export default function AddPlace(props: AddPlaceProps) {
  ...
  const selectAutoSuggest = (data: Place) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        {props.destination ? <p>{props.destination.name}</p> : null}
        <AutoComplete
          placeOnChange={selectAutoSuggest}
          granularity={GRANULARITIES.PLACES}
